...
export const sendSignUpEmail = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run('send-welcome-email', async () => {
            ...
            const introText = (part && 'text' in part ? part.text : null) ||'Thanks for joining stocksVisor. You now have the tools to track markets and make smarter moves.'
...
export const sendDailyNewsSummary = inngest.createFunction(
    ...
    async ({ step }) => {
        ...
        return { success: true, message: 'Scheduled news summary emails sent successfully' }
    }
)
